...
export const dictionaries: Record<Lang, Dictionary> = {
  en: {
    ...
    lede: "Elevated brand imagery, tailored to every digital format. From your website to social media and stories. Campaign-level visuals, without the traditional production.",
  ...
  de: {
    ...
    lede: "Hochwertige Brand-Imagery für jedes digitale Format. Von deiner Website bis Social Media und Stories. Campaign-Level Visuals, ohne klassische Produktion.",
    selectedWork: "Selected work",
  ...
  fr: {
    ...
    lede: "Des images de marque élevées, adaptées à chaque format digital. Du site web aux réseaux sociaux et Stories. Des visuels de niveau campagne, sans production traditionnelle.",
    selectedWork: "Selected work",
  ...
  es: {
    ...
    lede: "Imágenes de marca elevadas, adaptadas a cada formato digital. Desde tu web hasta redes sociales y Stories. Visuales de nivel campaña, sin producción tradicional.",
    selectedWork: "Selected work",
  ...
  it: {
    ...
    lede: "Imagery di brand elevata, su misura per ogni formato digitale. Dal sito web a social e Stories. Visual di livello campaign, senza produzione tradizionale.",
    selectedWork: "Selected work",
