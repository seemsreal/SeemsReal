...
export const dictionaries: Record<Lang, Dictionary> = {
  en: {
    ...
    navContact: "Contact",
    whatWeDo: "What we do",
    headline: "Fashion imagery that seems real.",
    lede: "SEEMS REAL Studio creates AI fashion imagery for brands — lookbooks, campaign visuals and product shots for website, social and ads. Elevated fashion photography energy, without traditional production.",
  ...
  de: {
    ...
    headline: "Fashion-Imagery, die real wirkt.",
    lede: "SEEMS REAL Studio erstellt AI Fashion Imagery für Brands — Lookbooks, Campaign Visuals und Product Shots für Website, Social Media und Ads. Fashion-Photography-Energie, ohne klassische Produktion.",
    selectedWork: "Selected work",
  ...
  fr: {
    ...
    headline: "Des images mode qui semblent réelles.",
    lede: "SEEMS REAL Studio crée des images mode par IA pour les marques — lookbooks, visuels de campagne et shots produit pour site, réseaux sociaux et pubs. L’énergie de la photo fashion, sans production traditionnelle.",
    selectedWork: "Selected work",
  ...
  es: {
    ...
    headline: "Imágenes de moda que parecen reales.",
    lede: "SEEMS REAL Studio crea AI fashion imagery para marcas — lookbooks, visuals de campaña y product shots para web, social y ads. Energía de fotografía fashion, sin producción tradicional.",
    selectedWork: "Selected work",
  ...
  it: {
    ...
    headline: "Immagini fashion che sembrano reali.",
    lede: "SEEMS REAL Studio crea AI fashion imagery per brand — lookbook, campaign visual e product shot per sito, social e ads. Energia della fashion photography, senza produzione tradizionale.",
    selectedWork: "Selected work",
