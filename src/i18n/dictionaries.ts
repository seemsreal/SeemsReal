...
export const dictionaries: Record<Lang, Dictionary> = {
  ...
  fr: {
    ...
    headlineLine1: "Une grande vision.",
    headlineLine2: "Sans grande production.",
    ledeLead:
      "Vous lancez une marque, créez un site web ou souhaitez enrichir votre portfolio ?",
    ledeRest:
      "Nous utilisons l’IA pour transformer votre vision en images haut de gamme, sans le temps, les coûts ni la complexité d’un shooting photo traditionnel.",
    ledeClose: "Votre produit. Votre vision. Made to seem real.",
    selectedWork: "Selected work",
  ...
  es: {
    ...
    headlineLine1: "Una gran visión.",
    headlineLine2: "Sin una gran producción.",
    ledeLead:
      "¿Estás creando una marca, desarrollando una página web o ampliando tu portfolio?",
    ledeRest:
      "Utilizamos AI para transformar tu visión en imágenes de alta calidad, sin el tiempo, los costes ni la complejidad de una sesión de fotos tradicional.",
    ledeClose: "Tu producto. Tu visión. Made to seem real.",
    selectedWork: "Selected work",
