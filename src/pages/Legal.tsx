...
function ImpressumNoticeFr() {
  const { lang } = useLanguage();

  return (
    <>
      <p>
        <strong>Informations légales / Mentions légales</strong>
      </p>

      <p>
        <strong>Propriétaire et responsable du site web</strong>
        <br />
        {impressum.name} / {impressum.brand}
        <br />
        {impressum.street}
      ...
      <p>
        ...
        <br />
        Membre de la Chambre économique fédérale d’Autriche (WKO)
        <br />
        Autorité de surveillance : Magistrat de la Ville de Steyr
        <br />
      ...
      <p>
        ...
        <br />
        Titulaire du compte : {impressum.name} / {impressum.brand}
        <br />
        Banque : {impressum.bank}
        <br />
        IBAN : {impressum.iban}
        <br />
        SWIFT/BIC : {impressum.bic}
        <br />
        <br />
        Remarque : ce compte est utilisé exclusivement pour le traitement des
        paiements. Le siège de l’entreprise est situé en Autriche.
      </p>
      ...
      <p>
        <strong>
          Informations conformément à la loi autrichienne sur les médias
        </strong>
        <br />
        Propriétaire du média : {impressum.name}
        <br />
        Objet de l’activité : Création de contenus visuels pour les marques,
        assistés et générés par intelligence artificielle, destinés aux
        entreprises.
        <br />
        Ligne éditoriale du site web : Présentation de SEEMS REAL Studio, de ses
        services et de son portfolio, ainsi que d’informations relatives à la
        production de contenus visuels assistée par intelligence artificielle.
      </p>

      <p>
        <strong>Clause de non-responsabilité</strong>
        <br />
        Tous les textes, images, vidéos et autres contenus publiés sur ce site
        web sont protégés par le droit d’auteur, sauf indication contraire.
        Toute reproduction, distribution, publication ou autre utilisation de
        ces contenus n’est autorisée qu’avec l’accord écrit préalable du
        titulaire des droits concerné.
        <br />
        <br />
        Malgré une vérification attentive des contenus de ce site web, nous
        déclinons toute responsabilité quant aux contenus des sites web externes
        accessibles par des liens depuis ce site. Les exploitants respectifs des
        sites liés sont seuls responsables de leur contenu.
      </p>

      <p>
        <strong>Mention relative aux contenus générés par IA</strong>
        <br />
        Les contenus visuels présentés sur ce site web peuvent être générés ou
        assistés par intelligence artificielle et sont créés à des fins
        illustratives, créatives et marketing. Les contenus générés ou assistés
        par IA sont identifiés comme tels lorsque cela est nécessaire.
        <br />
        <br />
        SEEMS REAL Studio crée pour les entreprises des contenus visuels de
        marque assistés et générés par intelligence artificielle. Vous trouverez
        de plus amples informations sur notre méthode de travail, l’utilisation
        de l’intelligence artificielle générative ainsi que les responsabilités
        respectives de SEEMS REAL Studio et de ses clients dans nos{" "}
        <button
          type="button"
          className="legal-inline-link"
          onClick={() => navigate(termsPathFor(lang))}
        ...
        et sur notre page consacrée à la{" "}
        <button
          type="button"
          className="legal-inline-link"
          onClick={() => navigate(aiTransparencyPathFor(lang))}
...
function AiTransparencyNoticeIt() {
  const { lang } = useLanguage();

  return (
    <>
      <p>
        SEEMS REAL Studio crea contenuti visivi per brand utilizzando
        l’intelligenza artificiale generativa. Questa pagina spiega il nostro
        metodo di lavoro in modo chiaro e trasparente.
      </p>

      <p>
        <strong>Come lavoriamo</strong>
        <br />
        Combiniamo il vostro briefing, i materiali relativi ai prodotti e la
        direzione creativa desiderata con la generazione di immagini assistita
        dall’IA e un’attenta revisione. I contenuti finali vengono creati come
        visual generati o assistiti dall’IA per la comunicazione del brand.
      </p>

      <p>
        <strong>Cosa potete aspettarvi</strong>
        <br />
        I nostri visual vengono creati con l’obiettivo di essere di alta
        qualità, adatti alle campagne e coerenti con il vostro brand. Poiché i
        sistemi di IA generativa sono probabilistici, possono verificarsi
        piccole variazioni, artefatti o somiglianze involontarie. La revisione e
        l’approvazione finale prima della pubblicazione spettano al Cliente.
      </p>

      <p>
        <strong>I vostri materiali</strong>
        <br />
        Le immagini dei prodotti, i loghi, le immagini di riferimento e gli
        altri materiali da voi forniti ci aiutano a creare visual in linea con
        il vostro brand. Dovete disporre dei diritti e delle autorizzazioni
        necessari per fornirci tali materiali ai fini della produzione
        assistita dall’IA.
      </p>

      <p>
        <strong>Trasparenza nell’utilizzo</strong>
        <br />
        A seconda della natura del contenuto e delle modalità con cui viene
        utilizzato o pubblicato, ai contenuti generati o manipolati tramite IA
        possono applicarsi obblighi di trasparenza previsti dall’EU AI Act.
        <br />
        <br />
        Dopo la consegna, il Cliente è responsabile di determinare e rispettare
        eventuali obblighi di informazione, etichettatura o trasparenza
        applicabili alla pubblicazione o all’utilizzo dei contenuti forniti. Ciò
        comprende, in particolare, i requisiti previsti dalla normativa
        applicabile e dalle politiche delle rispettive piattaforme. SEEMS REAL
        Studio rimane responsabile degli obblighi applicabili alle proprie
        attività e ai propri servizi.
        <br />
        <br />
        Ulteriori dettagli sono disponibili nei nostri{" "}
        <button
          type="button"
          className="legal-inline-link"
          onClick={() => navigate(termsPathFor(lang))}
...
function AiTransparencyNoticeEs() {
  const { lang } = useLanguage();

  return (
    <>
      <p>
        SEEMS REAL Studio crea contenidos visuales para marcas utilizando
        inteligencia artificial generativa. Esta página explica nuestro método
        de trabajo de forma clara y transparente.
      </p>

      <p>
        <strong>Cómo trabajamos</strong>
        <br />
        Combinamos su briefing, los materiales de sus productos y la dirección
        creativa deseada con la generación de imágenes asistida por IA y una
        revisión cuidadosa. Los contenidos finales se crean como visuales
        generados o asistidos por IA para la comunicación de la marca.
      </p>

      <p>
        <strong>Qué puede esperar</strong>
        <br />
        Nuestros visuales se crean con el objetivo de ser de alta calidad,
        adecuados para campañas y coherentes con su marca. Dado que los sistemas
        de IA generativa funcionan de manera probabilística, pueden producirse
        pequeñas variaciones, artefactos o similitudes involuntarias. La
        revisión y aprobación final antes de la publicación corresponden al
        Cliente.
      </p>

      <p>
        <strong>Sus materiales</strong>
        <br />
        Las imágenes de productos, logotipos, imágenes de referencia y otros
        materiales que nos proporcione nos ayudan a crear visuales alineados con
        su marca. Debe disponer de los derechos y autorizaciones necesarios para
        proporcionarnos dichos materiales con fines de producción asistida por
        IA.
      </p>

      <p>
        <strong>Transparencia en el uso</strong>
        <br />
        Dependiendo de la naturaleza del contenido y de cómo se utilice o
        publique, pueden aplicarse requisitos de transparencia establecidos por
        el Reglamento de Inteligencia Artificial de la UE (EU AI Act) a los
        contenidos generados o manipulados mediante IA.
        <br />
        <br />
        Tras la entrega, el Cliente es responsable de determinar y cumplir
        cualquier requisito de divulgación, etiquetado o transparencia aplicable
        a la publicación o utilización de los contenidos entregados. Esto
        incluye, en particular, los requisitos establecidos por la legislación
        aplicable y las políticas de las respectivas plataformas. SEEMS REAL
        Studio sigue siendo responsable de las obligaciones aplicables a sus
        propias actividades y servicios.
        <br />
        <br />
        Encontrará más información en nuestros{" "}
        <button
          type="button"
          className="legal-inline-link"
          onClick={() => navigate(termsPathFor(lang))}
...
export function AiTransparency() {
  ...
  return (
    <LegalPage title={aiTransparencyTitles[lang]}>{body}</LegalPage>
  );
}
